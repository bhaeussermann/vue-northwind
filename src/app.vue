<template>
  <div>
    <a id="github-ribbon" href="https://github.com/bhaeussermann/VueNorthwind/tree/vuetify" rel="noopener noreferrer" target="_blank">
    ...
    <v-app>
      <v-app-bar app>
        <h1 class="title">Northwind Manager</h1>
      </v-app-bar>
      <v-main>
        <v-container fluid>
          <router-view />
